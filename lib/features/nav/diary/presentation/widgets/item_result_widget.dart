                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        ...
                        offset:
                            const Offset(0, 1), // Vị trí tạo bóng (dọc, ngang)
                      ),
                    ],
                  ),
                ),
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              TextWidget(
                                text:
                                    controller.getCaloriesConsume().toString(),
                              ...
                              child: CircularPercentIndicator(
                                ...
                                center: Column(
                                  ...
                                  children: [
                                    TextWidget(
                                      text:
                                          controller.user!.getKcal().toString(),
                                      color: AppColors.primary,
